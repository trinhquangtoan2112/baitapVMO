...
import { changeTheme, getLoading, hideLoading } from '../../store/Reducer/LoadingReducer';
export default function Homelayout() {
    ...
    return (
        <div className={theme ? "dark-theme" : "421421124124"}>
            <button onClick={() => {
                changeTheme1()
            }}>Theme</button>
                    ...
                    <div className='login w-11/12 mx-auto text-right' >
                        ...
                        <div className={"cursor-pointer"}  >
                            <div className={`form `}>
                                ...
                                <input className={` form-control form-input ${theme ? "bg-black text-white " : "421421124124"}`} onChange={(e) => {
                                    searching(e)
